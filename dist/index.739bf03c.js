...
var _stackMotionEffectJs = require("./effect-1/stackMotionEffect.js");
var _stackMotionEffectJs1 = require("./effect-2/stackMotionEffect.js");
var _stackMotionEffectJs2 = require("./effect-3/stackMotionEffect.js");
...
const init = ()=>{
    ...
    document.querySelectorAll("[data-stack-1]").forEach((stackEl)=>{
        new (0, _stackMotionEffectJs.StackMotionEffect)(stackEl);
    });
    ...
    document.querySelectorAll("[data-stack-2]").forEach((stackEl)=>{
        new (0, _stackMotionEffectJs1.StackMotionEffect)(stackEl);
    });
    ...
    document.querySelectorAll("[data-stack-3]").forEach((stackEl)=>{
        new (0, _stackMotionEffectJs2.StackMotionEffect)(stackEl);
    });
    ...
    introCards.forEach((introCard)=>{
        (0, _gsap.gsap).to(introCard, {
            ...
            rotationX: ()=>-60,
            yPercent: ()=>(0, _gsap.gsap).utils.random(-100, 0),
            z: ()=>(0, _gsap.gsap).utils.random(-100, 0),
            filter: "brightness(0%)",
            scrollTrigger: {
                trigger: introCard,
...
(0, _utils.preloadImages2)(".grid__img").then(()=>{
    document.body.classList.remove("loading");
    init();
});

},{"./utils":"72Dku","./row":"d87VK","gsap":"fPSuC","gsap/Flip":"iKp6p","./effect-1/stackMotionEffect.js":"8uE8k","./effect-2/stackMotionEffect.js":"cZnxF","./effect-3/stackMotionEffect.js":"ksi6U"}],"72Dku":[function(require,module,exports) {
...
class StackMotionEffect {
    constructor(stackEl){
        ...
        this.imageElements = [
            this.contentElement.querySelectorAll(".card")
        ];
    ...
    initializeEffect(element) {
        ...
        const throttledResize = (0, _utilsJs.throttle)(()=>{
            winsize = {
                width: window.innerWidth,
                height: window.innerHeight
            };
